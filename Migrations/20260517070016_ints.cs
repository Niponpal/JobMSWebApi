    ...
    public partial class ints : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, 0, "81bcdb2d-9b03-4301-a303-05acc88ed973", new DateTime(2026, 5, 17, 13, 0, 15, 926, DateTimeKind.Local).AddTicks(660), 0L, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "admin@localhost.com", true, null, false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAELkOqA7U+GzkxRrRJS1JfWzUVzTtCxSDDBVPJh3ppzv0qazh6Fd+ZmIguueOtPmCPA==", null, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "128486a0-dbc6-4722-a3d2-0c2a0cfd1316", false, null, null, null, "admin@localhost.com" },
                    { 2L, 0, "1c7659a3-9780-4170-b858-6990ef44201a", new DateTime(2026, 5, 17, 13, 0, 15, 976, DateTimeKind.Local).AddTicks(4421), 0L, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "employer@localhost.com", true, null, false, null, "EMPLOYER@LOCALHOST.COM", "EMPLOYER@LOCALHOST.COM", "AQAAAAIAAYagAAAAENvVwHU2npLScRmL4RWviObqAru7Cj2xbIm7XRisvS1mk1BhdPQAFuwt3PBIZhBWBg==", null, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "a5af73f8-1d7f-44b0-9115-4f77c636a3f4", false, null, null, null, "employer@localhost.com" },
                    { 3L, 0, "15f15aa7-d70c-4692-b212-a34eb2ceb5f5", new DateTime(2026, 5, 17, 13, 0, 16, 23, DateTimeKind.Local).AddTicks(5766), 0L, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "candidate@localhost.com", true, null, false, null, "CANDIDATE@LOCALHOST.COM", "CANDIDATE@LOCALHOST.COM", "AQAAAAIAAYagAAAAEIgsJrdPBgayb8+JuALzyZAQtM97SqwOMPwTxqYYPmv3BaTG7L+PsaDC5nF6JXk6hQ==", null, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "3093b48e-b2fc-4ade-b457-5b9709c6a1ed", false, null, null, null, "candidate@localhost.com" }
                });
